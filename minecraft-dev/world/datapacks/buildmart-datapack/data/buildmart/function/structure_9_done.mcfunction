# file: structure_9_done.mcfunction
# Structure 9 is complete!
...
tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"BUILD MART","color":"gold","bold":true},{"text":"] ","color":"dark_gray"},{"text":"Structure 9 validated! ","color":"green"},{"text":"Ending round...","color":"yellow"}]
