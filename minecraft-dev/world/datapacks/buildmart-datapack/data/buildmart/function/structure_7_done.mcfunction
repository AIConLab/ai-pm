# file: structure_7_done.mcfunction
# Structure 7 is complete!
...
tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"BUILD MART","color":"gold","bold":true},{"text":"] ","color":"dark_gray"},{"text":"Structure 7 validated! ","color":"green"},{"text":"Ending round...","color":"yellow"}]
