...
tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"BUILD MART","color":"gold","bold":true},{"text":"] ","color":"dark_gray"},{"text":"Structure 1 validated! ","color":"green"},{"text":"Ending round...","color":"yellow"}]
