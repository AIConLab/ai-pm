# file: structure_6_done.mcfunction
# Structure 6 is complete!
...
tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"BUILD MART","color":"gold","bold":true},{"text":"] ","color":"dark_gray"},{"text":"Structure 6 validated! ","color":"green"},{"text":"Ending round...","color":"yellow"}]
