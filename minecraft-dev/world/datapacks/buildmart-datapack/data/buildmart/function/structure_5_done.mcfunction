# file: structure_5_done.mcfunction
# Structure 5 is complete!
...
tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"BUILD MART","color":"gold","bold":true},{"text":"] ","color":"dark_gray"},{"text":"Structure 5 validated! ","color":"green"},{"text":"Ending round...","color":"yellow"}]
