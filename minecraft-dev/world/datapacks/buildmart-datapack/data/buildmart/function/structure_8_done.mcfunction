# file: structure_8_done.mcfunction
# Structure 8 is complete!
...
tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"BUILD MART","color":"gold","bold":true},{"text":"] ","color":"dark_gray"},{"text":"Structure 8 validated! ","color":"green"},{"text":"Ending round...","color":"yellow"}]
