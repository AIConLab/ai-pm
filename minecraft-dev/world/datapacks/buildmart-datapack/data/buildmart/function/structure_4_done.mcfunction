# file: structure_4_done.mcfunction
# Structure 4 is complete!
...
tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"BUILD MART","color":"gold","bold":true},{"text":"] ","color":"dark_gray"},{"text":"Structure 4 validated! ","color":"green"},{"text":"Ending round...","color":"yellow"}]
