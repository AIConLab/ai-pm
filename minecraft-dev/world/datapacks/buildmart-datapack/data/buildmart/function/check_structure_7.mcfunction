...
execute store result score #stripped_wood_y bm_timer run fill ~-3 ~1 ~-3 ~3 ~15 ~3 minecraft:barrier replace minecraft:stripped_oak_wood[axis=y]
...
# --- Oak Fence Gate Checks (Confirmed) ---
